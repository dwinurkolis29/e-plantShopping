...
function ProductList({ onHomeClick }) {
        ...
        },
        {
            ...
            plants: [
                ...
                },
                {
                    ...
                    description: "Insect-repelling properties with pleasant scent.",
                    cost: "$20"
                },
                {
                    name: "Basil",
        ...
        },
        {
            ...
            plants: [
                ...
                },
                {
                    name: "Snake Plant",
                    image: "https://cdn.pixabay.com/photo/2021/01/22/06/04/snake-plant-5939187_1280.jpg",
                    description: "Needs infrequent watering and is pest-resilient.",
                    cost: "$15"
                },
                {
                ...
                },
                {
                    ...
                    description: "Requires minimal care and adds indoor color.",
                    cost: "$22"
                }
            ]
        }
    ...
    const categories = useMemo(() => {
        return ['all', ...plantsArray.map(cat => cat.category)];
    }, []);

    // Filter plants based on selected category
    const filteredPlants = useMemo(() => {
        if (selectedCategory === 'all') return plantsArray;
        return plantsArray.filter(cat => cat.category === selectedCategory);
    }, [selectedCategory]);
            ...
            <nav className="navbar">
                ...
                <div className="navbar-actions">
                    ...
                    <button className="cart-button" onClick={handleCartClick}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className="cart-icon">
                ...
                <>
                    ...
                    <section className="hero-section">
                        <div className="hero-content">
                            <h2 className="hero-title">Welcome to Paradise Nursery</h2>
                    ...
                    <div className="product-grid">
                        {filteredPlants.map((category, categoryIndex) => (
